 ...
 */
public class SizeColorPickerFragment extends Fragment {
    Context mContext;
        ...
        for(String size : mInputList)
        {
            ...
            cb.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ((AddToCartDialogFragment)getParentFragment()).refreshButton();
                }
            });
            cb.setText(size);
    ...
    public static SizeColorPickerFragment newInstance(ArrayList<String> inputs)
    {
        SizeColorPickerFragment frag = new SizeColorPickerFragment();
    ...
    public SizeColorPickerFragment()
    {
